...
$paths = @{
    ...
    VSCode_settings = @{ Source = "~\AppData\Roaming\Code\User\settings.json"; Destination = ".\Both\VSCode\" }
    VSCode_keybindings = @{ Source = "~\AppData\Roaming\Code\User\keybindings.json"; Destination = ".\Both\VSCode\" }
}
