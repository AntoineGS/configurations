...
if hostname == "antoinews-linux" then
	...
	hl.bind("SUPER + ALT + R", hl.dsp.exec_cmd("uwsm app -- gtk-launch org.remmina.Remmina"), { description = "Remmina" })
end
...
hl.bind("SUPER + CTRL + P",       hl.dsp.exec_cmd("uwsm app -- 1password --quick-access"),                                    { description = "1Password Quick Access" })
