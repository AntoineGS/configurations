...
elseif hostname == "antoinews-linux" then
	...
	hl.workspace_rule({ workspace = "2", layout = "dwindle", persistent = true })
	hl.workspace_rule({ workspace = "3", layout = "dwindle", persistent = true })
	hl.workspace_rule({ workspace = "4", layout = "dwindle", persistent = true })
	hl.workspace_rule({ workspace = "5", layout = "dwindle", persistent = true })
	hl.workspace_rule({ workspace = "6", layout = "dwindle", persistent = true })
	hl.workspace_rule({ workspace = "8", layout = "dwindle", persistent = true })
	hl.workspace_rule({ workspace = "9", layout = "dwindle", persistent = true })
	hl.workspace_rule({ workspace = "10", layout = "dwindle", persistent = true })
