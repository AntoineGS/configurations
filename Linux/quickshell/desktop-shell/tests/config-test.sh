...
assert.match(color, /property color low:\s*root\.pick\("notifications\.low",\s*"#89dceb"\)/)
...
const surfaceRoles = {
  ...
  "notifications.text-secondary": notificationPalette.secondaryText,
