...
// Themed single-select dropdown. Options may be strings or { value, label }
// objects; changed() always emits the selected value as a string.
Item {
  id: root
  ...
  Column {
    ...
    BorderSurface {
      ...
      readonly property var triggerBorderSpec: Border.controlSpec(
