...
**Arguments:** `[--preset minimal|standard|comprehensive]`
...
/* Do not edit directly. Regenerate with /ui-design__design-system-setup */
...
2. Run /ui-design__create-component to build with your design system
3. Run /ui-design__design-review to validate existing UI against tokens

Need to modify tokens? Run /ui-design__design-system-setup --preset {preset}
