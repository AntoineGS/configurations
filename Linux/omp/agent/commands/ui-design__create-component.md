...
Next steps:
1. Run /ui-design__design-review {path} to validate
2. Run /ui-design__accessibility-audit {path} for a11y check
3. Add to your page/layout

Need to create another component? Run /ui-design__create-component
```
