...
**Arguments:** `<feature description> [--stack react/fastapi/postgres] [--api-style rest|graphql] [--complexity simple|medium|complex]`
...
Gather requirements through interactive Q&A. Ask ONE question at a time using the `ask` tool. Do NOT ask all questions at once.
