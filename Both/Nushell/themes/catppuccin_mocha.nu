...
let scheme = {
  ...
  unrecognized_command: { fg: $theme.text attr: b }
  constant: { fg: $theme.peach attr: b }
  punctuation: $theme.overlay2
  operator: { fg: $theme.sky attr: b }
  string: { fg: $theme.green attr: b }
  virtual_text: $theme.surface2
  variable: { fg: $theme.flamingo attr: bi }
  filepath: { fg: $theme.yellow attr: b }
}
